...
addAttributeBtn.addEventListener("click", () => {
    ...
    select.classList.add("form-select"); // Thêm class cho select
    select.setAttribute("aria-label", "Default select example");  // Thêm aria-label
    
    // Thêm thẻ select vào DOM (có thể thay đổi phần tử này nếu cần)
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.code == 200) {
                ...
                let optionsHTML = '<option selected>Open this select menu</option>';
