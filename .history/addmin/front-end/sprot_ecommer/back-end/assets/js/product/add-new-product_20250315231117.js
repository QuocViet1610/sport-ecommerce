        ...
        success: function(response) {
            if (response.code == "200" && response.data) {
                ...
                values.forEach(valueObj => {
                    ...
                    if (attributeSelected.includes(valueObj.id)) {  // Sử dụng includes để kiểm tra giá trị có trong mảng
                        option.classList.toggle("selected");  // Thêm hoặc xóa lớp "selected"
                    }
