...
addAttributeBtn.addEventListener("click", () => {
    ...
    changeBtn.classList.add("change-value-btn");
    changeBtn.textContent = "Thay đổi giá trị";
    
    // Thêm sự kiện click cho nút "Thay đổi giá trị"
    changeBtn.addEventListener("click", () => {
        // Thay đổi giá trị của select khi người dùng bấm nút
        select.value = "thuoc_tinh_2";  // Thay đổi giá trị theo yêu cầu (ví dụ: chọn "THUỘC TÍNH 2")
        console.log("Giá trị hiện tại của select sau khi thay đổi:", select.value);
    });
    
    // Thêm select và nút vào DOM (ví dụ thêm vào body)
