...
$(document).ready(function () {
    ...
    let selectedProductId = null; // Biến lưu ID sản phẩm cần xóa

    // Khi bấm vào nút xóa, lấy ID sản phẩm
    $(document).on("click", ".delete-btn", function () {
        selectedProductId = $(this).data("id"); // Lưu ID sản phẩm vào biến
        console.log("🔴 ID sản phẩm được chọn để xóa:", selectedProductId);
        
        // Hiển thị thông báo khi nút xóa được bấm
        ...
        if (selectedProductId !== null) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#exampleModalToggle").modal("hide"); // Đóng modal sau khi xóa
            ...
            <tr class="product-row parent-row" data-id="${product.id}">
                ...
                <td>
                    <ul>
                        ...
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle" data-id="${product.id}" class="delete-btn">
