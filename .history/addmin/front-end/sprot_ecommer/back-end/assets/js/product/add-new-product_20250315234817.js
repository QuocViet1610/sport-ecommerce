...
function openQuickSelectPopup(attribute, valueContainer) {
    ...
    confirmPopup.onclick = () => {
        ...
        // Xóa các giá trị thuộc tính có ID trong mảng selectedAttributeList
        selectedAttributeList = selectedAttributeList.filter(attr => !selectedQuickAttributes.some(value => value.id === attr.id));
