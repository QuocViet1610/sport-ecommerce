        ...
        if (product.variants.length > 0) {
            ...
            product.variants.forEach((variant, index) => {
                ...
                <tr class="product-variants child-row product-last" data-parent="${product.id}" style="display: none;  border-right: 1px solid green;">
                 ...
                 <tr class="product-variants child-row product-last" data-parent="${product.id}" style="display: none; border-bottom: 1px solid green ; border-left: 1px solid green; border-right: 1px solid green;">
