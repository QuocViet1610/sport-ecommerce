            ...
            if (response.code == "200" && response.data) {
                ...
                values.forEach(valueObj => {
                    ...
                    option.onclick = () => {
                        ...
                        // Cập nhật lại giao diện ngay lập tức sau khi thay đổi màu
                        // Việc gọi `option.style` trong đây đảm bảo rằng màu nền sẽ thay đổi ngay lập tức khi lớp "selected" được thêm/xóa.
                    };
