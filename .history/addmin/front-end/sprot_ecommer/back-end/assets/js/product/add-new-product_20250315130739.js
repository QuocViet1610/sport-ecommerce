    ...
    newAttribute.innerHTML = `
        <div class="dropdown">
            <button class="btn btn-success dropdown-toggle" type="button" id="dropdownButton${attributeCount}" data-bs-toggle="dropdown" aria-expanded="false">
                Thuộc tính ${attributeCount}
            </button>
            <ul class="dropdown-menu" id="dropdownMenu${attributeCount}">
                <li><a class="dropdown-item" href="#" onclick="openPopup('${attributeCount}')">Chọn giá trị</a></li>
            </ul>
        </div>
    `;
...
function openPopup(attributeId) {
    ...
    const values = ['Red', 'Blue', 'Green', 'Large', 'Small']; // Thêm giá trị mẫu của thuộc tính vào đây
...
function selectValue(value, attributeId) {
    const selectedButton = document.querySelector(`#dropdownButton${attributeId}`);
    selectedButton.innerHTML = `Thuộc tính ${attributeId}: ${value}`;
