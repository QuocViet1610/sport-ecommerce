    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.data && response.data.length > 0) {
                brandSelect.append('<option value="" disabled selected>Chọn thương hiệu</option>');
        ...
        error: function(xhr, status, error) {
            ...
            let brandSelect = $("#brand");
            brandSelect.empty();
            brandSelect.append('<option value="" disabled selected>Không thể tải thương hiệu</option>');
        }
    });
});
