        ...
        success: function(response) {
            if (response.code == 200) {
                ...
                select.addEventListener('change', function() {
                    const selectedAttributeId = select.value;  // Lấy ID thuộc tính đã chọn
                    console.log('ID thuộc tính đã chọn:', selectedAttributeId);
                    
                    // Bạn có thể làm gì đó với ID ở đây, ví dụ, hiển thị trong UI hoặc lưu vào biến
                    // Ví dụ: Hiển thị ID trong một div
