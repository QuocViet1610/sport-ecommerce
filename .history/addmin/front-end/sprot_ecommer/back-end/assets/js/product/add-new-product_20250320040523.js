    ...
    variants.forEach(variant => {
        ...
        if (priceStock && costPriceInput && priceInput) {
            row.innerHTML = `
                ...
                <td>Tự động</td>
                <td><input type="text" value="${priceStock.value}" class="cost-price price"></td>
                <td><input type="text" value="${priceInput.value}" class="sale-price price"></td>
                <td><input type="text" value="${costPriceInput.value}" class="stock-quantity price-stock"></td>
...
const variant = urlParams.get('product-id');
