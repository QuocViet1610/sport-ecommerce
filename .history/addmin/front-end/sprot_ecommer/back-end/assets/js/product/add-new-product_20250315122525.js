...
// Lắng nghe sự kiện 'change' của select2
$('#select2-5m3k-container').on('change', function() {
    const selectedAttributeId = $(this).val(); // Lấy giá trị ID của thuộc tính đã chọn
