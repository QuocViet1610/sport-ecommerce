...
document.body.appendChild(dropdownContainer);  // Thêm dropdownContainer vào DOM (có thể thay đổi theo vị trí bạn muốn)
...
$.ajax({
    ...
    success: function(response) {
        if (response.code == 200) {
            ...
            // Lắng nghe sự kiện khi người dùng chọn một mục trong dropdown
            dropdownMenu.addEventListener('click', function(e) {
                if (e.target && e.target.classList.contains('dropdown-item')) {
                    ...
                    // Lưu ID vào một biến toàn cục hoặc làm gì đó với ID
