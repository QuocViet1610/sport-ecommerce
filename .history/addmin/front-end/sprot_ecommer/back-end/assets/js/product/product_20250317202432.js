...
function renderProductTable(products) {
    ...
    if (product.variants.length > 0) {
        ...
        let avgPrice = totalPrice / product.variants.length;
        wrapperRow += `${formatCurrency(avgPrice)}`;
    } else {
    ...
    if (product.variants.length > 0) {
        ...
        let avgCostPrice = totalCostPrice / product.variants.length;
        wrapperRow += `${formatCurrency(avgCostPrice)}`;
    } else {
