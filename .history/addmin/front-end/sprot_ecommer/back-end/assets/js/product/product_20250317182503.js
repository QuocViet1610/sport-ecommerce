...
$(document).ready(function () {
    ...
    // Khi bấm nút xóa, lưu ID sản phẩm và hiển thị modal
    $(document).on("click", ".delete-btn", function () {
        selectedProductId = $(this).data("id");

        // Đặt modal hiện tại thành `inert` để ngăn chặn focus
        $("#exampleModalToggle").attr("inert", true);

        // Hiển thị modal mới
        $("#exampleModalToggle").modal("show");
    });

    // Khi modal cũ hoàn tất đóng, loại bỏ `inert`
    $("#exampleModalToggle").on("hidden.bs.modal", function () {
        $(this).removeAttr("inert");
    });

    // Khi nhấn Yes, hiển thị ID sản phẩm bị xóa
    $("#confirmDelete").click(function () {
        console.log("🗑 Sản phẩm đã bị xóa có ID:", selectedProductId);

        // Đóng modal xóa sau khi xác nhận
            ...
            <tr class="product-row parent-row" data-id="${product.id}">
                ...
                <td>
                    <ul>
                        ...
                        <li><a href="#"><i class="ri-pencil-line" ata-id="${product.id}"></i></a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle" ata-id="${product.id}">
