...
$(document).ready(function () {
    ...
    $(document).on("click", ".delete-btn", function () {
        ...
        isDeleteVariant = $(this).data("variant") || false; // Lấy giá trị isDeleteVariant từ data
    
        console.log("🔴 ID sản phẩm được chọn để xóa:", selectedProductId, " | Xóa Variant:", isDeleteVariant);
    ...
    $("#confirmDelete").off("click").on("click", function () {
        ...
        if (!isDeleteVariant) {
            ...
            console.log("🟠 Xóa biến thể có ID:", selectedProductId);
    ...
    products.forEach(product => {
        ...
        if (product.variants.length > 0) {
            product.variants.forEach(variant => {
                wrapperRow += `
                    <tr class="product-variants child-row" data-parent="${variant.id}" style="display: none; border: 1px solid #000 !important;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                ...
                                                <li><a href="#"><i class="ri-pencil-line" data-id="${variant.id}"></i></a></li>
                                                <li>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle" 
