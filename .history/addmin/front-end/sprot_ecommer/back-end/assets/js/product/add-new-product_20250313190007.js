...
addAttributeBtn.addEventListener("click", () => {
    ...
    /*** Bọc SELECT + EDIT BUTTON trong một div ***/
    ...
    selectWrapper.appendChild(selectContainer); // Bọc lại

    /*** Bọc ACTIONS (Value, Quick Select, Delete) trong một div ***/
    ...
    actionWrapper.appendChild(actionContainer); // Bọc lại

    /*** Gán tất cả vào `attributeGroup` ***/
    attributeGroup.appendChild(selectWrapper);
    attributeGroup.appendChild(actionWrapper);
