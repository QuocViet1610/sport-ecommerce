...
document.addEventListener("DOMContentLoaded", function () {
    // Lắng nghe sự kiện click vào tbody.product-group
    ...
    // Ngăn chặn sự kiện khi chọn checkbox của thẻ cha
    $(".select-product").on('change', function (event) {
        event.stopPropagation();  // Ngừng sự kiện tiếp tục
