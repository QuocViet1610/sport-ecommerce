    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.data && response.data.length > 0) {
                ...
                // Chuyển đổi parentId thành dạng chuỗi để tránh lỗi so sánh kiểu dữ liệu
                ...
                console.log("Category Map:", categoryMap); // 🛠 Log danh mục đã nhóm
    
                // Gọi hàm để render danh mục (Bắt đầu từ gốc `parentId = null`)
