                    ...
                    wrapperRow += `
                          <tr class="product-variants child-row" data-parent="${product.id}" style="display: none; border: 1px solid #000 !important; " >
                            <td colspan="8" style="text-align: center; font-weight: bold;">
                                Đây là biến thể cuối cùng của sản phẩm
                            </td>
                        </tr>
                        <!-- Thêm một dòng tr trống với border-bottom -->
                         <tr class="product-variants child-row" data-parent="${product.id}" style="display: none; border: 1px solid #000 !important; border-bottom: 2px solid green !important; ">
                            <td colspan="8" style="text-align: center; font-weight: bold;">
                                Kết thúc danh sách biến thể
                            </td>
                        </tr>
                    `;
                }
