...
function renderVariants(variants) {
    ...
    variants.forEach(variant => {
        ...
        <td>Tự động</td>
        <td><input type="text" value="0" class="cost-price"></td>
        <td><input type="text" value="0" class="sale-price"></td>
        <td><input type="text" value="0" class="stock-quantity"></td>
...
const priceInput = document.getElementById('stock'); // Lấy phần tử theo id 'stock'
const stockInput = document.querySelector('.stock-quantity'); // Lấy phần tử theo class 'stock-quantity'

// Cập nhật giá trị của .stock-quantity khi giá trị của .price thay đổi
