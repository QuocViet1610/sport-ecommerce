...
$(document).ready(function() {
            ...
            if(response.code == 200) {
                    ...
                    if (children[parentId]) {
                        children[parentId].forEach(function(child) {
                            ...
                            var childItem = $('<div>', {
                                ...
                                html: '&nbsp;&nbsp;&nbsp;&nbsp;'.repeat(level) + child.name,
                                click: function() {
                                    selectItem(child.name); // Khi chọn mục con
                                }
                            });
                ...
                parents.forEach(function(parent) {
                    var parentItem = $('<div>', {
                        ...
                        text: parent.name,
                        click: function() {
                            selectItem(parent.name); // Khi chọn mục cha
                        }
                    });
    ...
    function selectItem(name) {
        // Gắn tên thể loại được chọn vào biến value
        value = name;
        console.log("Giá trị thể loại được chọn:", value); // In ra giá trị của biến value
    }
