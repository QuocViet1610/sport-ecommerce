        ...
        success: function(data) {
            ...
            if(data.code == 200) {
                ...
                $.each(data.data, function(index, item) {
                    dropdownMenu.append('<li><a class="dropdown-item" href="#" data-name="' + item.name + '">' + item.name + '</a></li>');
                });
    
                // Sử dụng delegation để gắn sự kiện click cho các mục dropdown
                $(document).on('click', '.dropdown-item', function() {
                    ...
                    $('#myDropdownBrand').empty(); // Ẩn dropdown sau khi chọn
                });
