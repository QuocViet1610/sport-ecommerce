    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(data.code == 200) {
                ...
                dropdownMenu.append('<li><input type="text" class="form-control" id="myInputBrand" placeholder="Search..." onkeyup="filterFunction()"></li>');
...
function filterFunction() {
    const input = document.getElementById("myInputBrand");
    const filter = input.value.toUpperCase();
    const div = document.getElementById("myDropdownBrand");
