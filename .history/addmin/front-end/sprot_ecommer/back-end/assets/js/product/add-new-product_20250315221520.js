                ...
                values.forEach(valueObj => {
                    ...
                    option.onclick = () => {
                        ...
                        if (option.classList.contains("selected")) {
                            ...
                            selectedTagIdsRemove.push(valueObj.id) // Thêm id vào mảng xóa
...
function createValueTag(valueObj, attribute, container) {
    ...
    removeBtn.onclick = () => {
        ...
        selectedTagIds = selectedTagIds.filter(id => id !== valueObj.id); // Loại bỏ ID khỏi mảng đã chọn
        selectedTagIdsRemove = selectedTagIdsRemove.filter(id => id !== valueObj.id); // Loại bỏ ID khỏi mảng xóa
    };
