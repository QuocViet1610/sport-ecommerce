    ...
    `;
        ...
        if (product.variants.length > 0) {
            ...
            product.variants.forEach((variant, index) => {
                wrapperRow += `
                    <tr class="product-variants child-row" data-parent="${product.id}" style="display: none; style="border-left: 1px solid green; border-right: 1px solid green; border-bottom: none;">
                        <td colspan="8">
