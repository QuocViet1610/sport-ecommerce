        ...
        if(response.code == 200) {
                ...
                if (children[parentId]) {
                    children[parentId].forEach(function(child) {
                        ...
                        var childItemModel = $('<div>', {
                            ...
                            html: '&nbsp;&nbsp;&nbsp;&nbsp;'.repeat(level) + child.name,
                            click: function() {
                                selectItemmModel(child.id); // Khi chọn mục con, lưu ID vào value
            ...
            parents.forEach(function(parent) {
                ...
                var parentItem = $('<div>', {
                    ...
                    text: parent.name,
                    click: function() {
                        selectItemmModel(parent.id); // Khi chọn mục cha, lưu ID vào value
                        $('#myDropdownModal').text(parent.name);
                    }   
                });
