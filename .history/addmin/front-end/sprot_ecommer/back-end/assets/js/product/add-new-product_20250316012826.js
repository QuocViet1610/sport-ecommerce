...
attributeGroups.forEach(group => {
    // Lấy attributeId từ thẻ select có class .attribute-dropdown trong .attribute-group
    let attributeId = group.querySelector(".attribute-dropdown") ? parseInt(group.querySelector(".attribute-dropdown").value) : null;
