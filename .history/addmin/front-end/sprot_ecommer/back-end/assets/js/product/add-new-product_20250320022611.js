...
$(document).ready(function () {
    ...
    // Lắng nghe sự kiện input trên trường .price
    priceInput.addEventListener('input', function() {
        // Lấy tất cả các trường .stock-quantity trong bảng
        const stockInputs = document.querySelectorAll('.stock-quantity');
        
        // Cập nhật giá trị của từng .stock-quantity trong bảng với giá trị từ input .price
