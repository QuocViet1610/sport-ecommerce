...
attributeGroups.forEach(group => {
    // Lấy thông tin của thuộc tính từ select (tên hoặc giá trị)
    ...
    // Kiểm tra nếu có attributeId từ data-id trong phần tử select
    ...
    // Kiểm tra nếu có attributeId và các giá trị valueIds hợp lệ
    if (attributeId && valueIds.length > 0) {
        // Tạo đối tượng AttributeProductCreatRequest và thêm vào mảng attributeCreatRequests
