...
function renderVariants(variants) {
    ...
    variants.forEach(variant => {
        ...
        <td>Tự động</td>
        <td><input type="text" value="0" class="cost-price-input price"></td>
...
$(document).ready(function () {
    ...
    // Lắng nghe sự kiện input trên phần tử costPrice
    const costPriceInput = document.getElementById('costPrice');
    
    costPriceInput.addEventListener('input', function() {
        // Lấy tất cả các input có class 'cost-price' và cập nhật giá trị
        const costPriceInputs = document.querySelectorAll('.cost-price-input');
        costPriceInputs.forEach(costPriceInput => {
