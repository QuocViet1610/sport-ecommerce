        ...
        if (product.variants.length > 0) {
            ...
            product.variants.forEach((variant, index) => {
                ...
                <tr class="product-variants child-row" data-parent="${product.id}" style="display: none; border-bottom: 1px solid green ; border-left: 1px solid green; border-right: 1px solid green;">
                            <td colspan="12" style="text-align: center; font-weight: bold;  border-left: 1px solid green; border-right: 1px solid green;">
                            </td>
                                   <div class="variant-container">
                                <table class="variant-table">
                                    <tr>
                                <td>
                                    <input type="checkbox" class="select-variant" data-parent="a" data-id=""/>
                                </td>
                                        <td>
                                            <div class="table-image">
                                        ...
                                        <td>
                                            <ul>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#productDetailModal">
                                                    <i class="ri-eye-line" data-id=""></i>
                                                </a>
                                                <li><a href="#"><i class="ri-pencil-line" data-id="" class="edit-btn"></i></a></li>
                                                <li>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle" 
                                                       data-id="" class="delete-btn-variant">
                                                        <i class="ri-delete-bin-line"></i>
                                                    </a>
                                                </li>
                                            </ul>
