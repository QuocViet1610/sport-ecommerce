...
// Khi bấm vào nút "Tạo mới", popup sẽ hiển thị
$('#createAttribute').on('click', function() {
    $('#popup').fadeIn();  // Hiển thị popup với hiệu ứng fade in
});

// Khi bấm vào dấu X để đóng popup
$('#popupClose').on('click', function() {
    $('#popup').fadeOut();  // Ẩn popup với hiệu ứng fade out
});

// Nếu người dùng bấm ra ngoài popup, nó cũng sẽ đóng
