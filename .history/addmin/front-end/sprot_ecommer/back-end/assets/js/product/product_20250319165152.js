...
document.addEventListener("DOMContentLoaded", function () {
    let isCheckboxChanging = true; // Flag để kiểm tra xem người dùng có đang thay đổi checkbox không

    // Lắng nghe sự kiện thay đổi checkbox của sản phẩm cha
    $(".select-product").on('change', function () {
        isCheckboxChanging = false; // Đánh dấu rằng checkbox đang được thay đổi
        console.log("hello");
