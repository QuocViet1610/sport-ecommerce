...
$(document).ready(function () {
    ...
    $("#confirmDelete").click(function () {
        ...
        // Đóng modal sau khi hiển thị ID
                ...
                <td>
                    <ul>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#productDetailModal">
                            <i class="ri-eye-line" data-id="${item.id}"></i>
                        </a>
                        <li><a href="#"><i class="ri-pencil-line" ata-id="${item.id}"></i></a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle" ata-id="${item.id}">
