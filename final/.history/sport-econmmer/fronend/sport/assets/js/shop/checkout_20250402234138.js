    ...
    function setDistrictAndWard(provinceId, districtId, wardId, districtName, wardName) {
        renderPlaceUpdate().then(function() {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    $("#ward").val(wardId);
                }, 1000);  // Thời gian chờ cho việc load wards (có thể điều chỉnh tùy vào tốc độ tải)
            }, 2000);  // Thời gian chờ cho việc load districts (có thể điều chỉnh tùy vào tốc độ tải)
