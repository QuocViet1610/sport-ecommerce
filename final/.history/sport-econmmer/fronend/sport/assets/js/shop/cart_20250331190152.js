$(document).ready(function () {
    ...
    function updateCartQuantity(productId, newQuantity) {
        ...
        let totalAmount = 0;
        cart.forEach(item => {
            totalAmount += item.productPrice * product.productStock;  // Cộng tổng tiền (giá * số lượng)
        });
        displayTotalAmount()
...
function displayTotalAmount() {
    ...
    // Hiển thị tổng tiền vào một phần tử trong giao diện (ví dụ, có ID là #totalAmount)
            ...
            cartHTML += `
                <tr class="product-box-contain">
                    ...
                    <td class="subtotal">
                        ...
                        <h5 id="totalProduct">${totalPrice.toLocaleString()}đ</h5>
                    </td>
