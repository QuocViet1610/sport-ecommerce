                    ...
                    <div class="delivery-address-box">
                        <div>
                            <div class="form-check">
                                <input class="form-check-input" id="addressDefault" type="radio" name="jack" ${address.isDefault === 1 ? 'checked' : ''}>
                            </div>
...
function displaySelectedAddress(radio) {
    ...
    var addressText = radio.closest('.delivery-address-box').find('.text-content').text(); // Lấy thông tin địa chỉ

    // Hiển thị thông tin trong console (có thể thay đổi thành hiển thị trên giao diện của bạn)
