        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === "200") {
                    ...
                    // Cập nhật quận/huyện và phường/xã
                    ...
                    // Lưu id địa chỉ vào form để biết là đang sửa địa chỉ nào
...
// Hàm để mở modal thêm địa chỉ mới
$(document).on('click', '#openModalBtnAddress', function() {
    ...
    $("#addressForm").data('addressId', null);  // Không có addressId khi thêm mới
    renderPlace();  // Load lại danh sách các tỉnh/thành phố, quận/huyện, phường/xã
});

// Hàm gửi yêu cầu thêm mới hoặc cập nhật địa chỉ
