...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === "200") {
                    ...
                    $("#city").val(address.provinceId).trigger('change'); 
    ...
    function setProcinve(provinceId, districtId, wardId, districtName, wardName) {
        $("#district").empty();
        $.ajax({
            url: "https://online-gateway.ghn.vn/shiip/public-api/master-data/district",
            method: "GET",
    ...
    function setDistrictAndWard(provinceId, districtId, wardId, districtName, wardName) {
        ...
        $.ajax({
            ...
            success: function(response) {
                let districtHtml = `<option value="${districtId}">${districtName}</option>`;
                ...
                // Gọi setWard để cập nhật phường/xã
                setWard(districtId, wardId, wardName);
            },
            error: function(xhr, status, error) {
                let errorMessage = "Lỗi khi tải quận/huyện";
    ...
    function setWard(districtId, wardId, wardName) {
        ...
        $.ajax({
            ...
            success: function(response) {
                let wardHtml = `<option value="${wardId}">${wardName}</option>`;
