...
$(document).ready(function() {
    ...
    $.ajax({
        url: "http://localhost:8080/addresses",  // URL API của bạn (thay {{local}} bằng URL thực tế)
        type: "GET",
        success: function(response) {
            if (response.code === "200") {
                // Xử lý dữ liệu trả về và hiển thị địa chỉ
    ...
    function displayAddresses(addresses) {
        // Lặp qua danh sách địa chỉ và hiển thị mỗi địa chỉ
