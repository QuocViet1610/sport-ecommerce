...
$(document).ready(function() {
    ...
    $("#addressForm").submit(function(event) {
        ...
        var formData = {
            ...
            provinceName: $("#city").val(),
            provinceId: 1, // Thêm ID tỉnh (có thể lấy từ lựa chọn)
            districtName: $("#district").val(),
            districtId: 1, // Thêm ID quận
            wardName: $("#ward").val(),
            wardId: 1, // Thêm ID phường
            country: "Việt Nam", // Hoặc lấy từ input nếu có
            isDefault: 1, // Đặt mặc định (hoặc từ checkbox)
            note: $("#notes").val(),
