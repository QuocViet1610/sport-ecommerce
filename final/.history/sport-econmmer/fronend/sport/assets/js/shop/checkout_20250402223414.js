        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === "200") {
                    ...
                    // Set giá trị cho các trường select
                    $("#city").val(address.provinceId); 
                    $("#district").val(address.districtId); 
                    $("#ward").val(address.wardId);                    
    
                    // Lấy và cập nhật text cho các trường
                    var provinceText = $("#city option:selected").text();
                    ...
                    // Nếu cần, bạn có thể lưu lại các text này hoặc hiển thị trong modal
                    // Ví dụ: 
                    // $("#provinceText").text(provinceText);
                    // $("#districtText").text(districtText);
                    // $("#wardText").text(wardText);
