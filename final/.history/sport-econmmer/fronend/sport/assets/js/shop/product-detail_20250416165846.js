...
function renderProductImages(product) {
    ...
    if (mainImage) {
        ...
        // Chờ cho ảnh chính tải xong rồi hiển thị ảnh phụ
        $('#main-image').on('load', function() {
            ...
            // Hiển thị ảnh phụ sau khi ảnh chính đã tải xong
            $('#sidebar-images').show();
        });
    } else {
        console.error("Ảnh chính không tìm thấy!");
    }
}
