...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    response.data.forEach(function(district) {
                        districtHtml += `<option value="${district.DistrictID}" ${district.DistrictID === districtId ? 'selected' : ''}>${district.DistrictName}</option>`;
                    });
                    $("#district").html(districtHtml); 

                    setWard(districtId, wardId, wardName);
    ...
    function setWard(districtId, wardId, wardName) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === "200") {
                    ...
                    var wardHtml =  `<option value="${wardId}">${wardName}</option>`;
