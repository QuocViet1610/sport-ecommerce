...
function renderProductAttributes(products) {
    productVariantsArray = productData.productVariants;
    ...
    $('.attribute-value').on('click', function() {
        ...
        var attributeId = $this.closest('.product-package').data('id'); // Lấy attributeId từ data-id
        ...
        var existingIndex = selectedAttributeIds.findIndex(function(item) {
            return item.attributeId === attributeId;  // Tìm thuộc tính đã chọn trong mảng bằng attributeId
        });
