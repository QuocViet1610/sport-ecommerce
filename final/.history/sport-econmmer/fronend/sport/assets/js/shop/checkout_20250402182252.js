                        ...
                        <ul class="delivery-address-detail">
                            ...
                            <li>
                                <div class="action-buttons" style="display: flex; justify-content: flex-end;">
                                    ...
                                    <!-- Button Xóa -->
                                    <button class="btn delete-btn" style="padding:0px; color:red;" data-id="${address.id}">
...
var openModalBtn = document.getElementById("openModalBtnAddress");
var closeModalBtn = document.getElementsByClassName("close")[0];

// Khi người dùng nhấn vào nút "Thêm địa chỉ mới", modal sẽ mở
...
// Chỉnh sửa địa chỉ - bạn có thể viết thêm sự kiện xử lý nút chỉnh sửa nếu cần
$(document).on('click', '.edit-btn', function() {
    var addressId = $(this).data('id');
    console.log("Chỉnh sửa địa chỉ ID:", addressId);
    // Mở modal và thực hiện hành động chỉnh sửa
});

// Xóa địa chỉ - bạn có thể viết thêm sự kiện xử lý nút xóa nếu cần
$(document).on('click', '.delete-btn', function() {
    var addressId = $(this).data('id');
    console.log("Xóa địa chỉ ID:", addressId);
    // Gửi yêu cầu xóa địa chỉ từ API
});
