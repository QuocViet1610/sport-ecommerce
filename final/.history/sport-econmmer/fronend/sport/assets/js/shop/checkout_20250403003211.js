...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.code === "200") {
                    ...
                    // Cập nhật lại quận/huyện và phường/xã
                    setDistrictAndWard(address.provinceId,address.provinceName ,address.provinceName, address.districtId, address.wardId, address.districtName, address.wardName);
    ...
    function setDistrictAndWard(provinceId,provinceName, districtId, wardId, districtName, wardName) {
        renderPlaceUpdate().then(function() {
            ...
            $('#city').append(new Option(wardprovinceNameName, provinceId)).val(provinceId);
