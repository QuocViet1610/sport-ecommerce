...
function renderProductImages(product) {
    ...
    $('#main-image').on('load', function() {
        // Sử dụng window.onload để đảm bảo trang đã tải xong
        setTimeout(function() {
    ...
    // Sử dụng window.onload để kích hoạt khi trang đã hoàn thành tải
    window.onload = function() {
        $('#main-image').trigger('load'); // Kích hoạt sự kiện load của ảnh chính
    };
}
