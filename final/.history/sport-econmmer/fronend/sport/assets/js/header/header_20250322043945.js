...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (res) {
            const data = res.data;
            const level2 = data.filter(cat => cat.level === 2 && findParent(cat, parentIdName));
            const level3 = data.filter(cat => cat.level === 3 && findParent(cat, parentIdName));
