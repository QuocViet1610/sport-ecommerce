...
function displayCart(cart) {
    ...
    if (cart.length === 0) {
        ...
        li.innerHTML = `
<div class="drop-cart d-flex justify-content-center align-items-center py-4" style="height: 100px;">
    <h4 class="fw-bold mb-0">Giỏ hàng trống</h4>
</div>
        `;
        ...
        li.innerHTML = `
            <div class="drop-cart">
                ...
                <div class="drop-contain">
                    <a href="product-left-thumbnail.html?id=${id}">
                        <h5>${productName}</h5>
                    </a>
